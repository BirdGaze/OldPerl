#devicenm.pl produces printer name - basically sysName from snmp reachable devices
use BER;
...
if($#ARGV < 1) {
die "usage: devicenm.pl <list of hosts> <output file>\n"
}
...
$community = "public";
$port = 161;
$oidSysDescr = encode_oid (1, 3, 6, 1, 2, 1, 1, 5, 0);
